...
relations_dict = {'no_relation': 'NO_RELATION', 'per:title': 'PERSON-TITLE', 
                ...
                'per:country_of_death': 'PERSON-COUNTRY_OF_DEATH', 'per:identity': "PERSON-IDENTITY",
                'org:city_of_branch': 'ORGANIZATION-COTY_OF_BRANCH','org:stateorprovince_of_branch':  'ORGANIZATION-STATE_OR_PROVINCE_OF_BRANCH',
                'org:country_of_branch': 'ORGANIZATION-COUNTRY_OF_BRANCH'}
